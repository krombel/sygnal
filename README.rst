...
mqtt
  This sends push notifications via a MQTT-Broker. Apps have to subscribe to a
  specific topic (default: mpush/<username>/<client_id>) to receive the
  notifications. The client_id is generated by the client and transmitted to
  sygnal as "pushkey".
